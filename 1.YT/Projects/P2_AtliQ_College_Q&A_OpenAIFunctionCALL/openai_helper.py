...
def get_answer(question):
    ...
    if response_message.get("function_call"):
        ...
        ## We will append response message . Because it will help chatgpt to setup a context and he can ans well
        ...
        ## If no function call is done. It means we have asked question . Which is answered by general chatgpt
